      ...
      <div className="col-6 col-md">
        ...
        <div className="list-unstyled text-small dev-list">
          <a
            ...
            target="new">{REACT_APP_LINK1_NAME}
          </a>
          {
            REACT_APP_NAME_PDF && REACT_APP_PDF_LINK !== null
              ?
              <React.Fragment> / <a className="link-footer"
                href={REACT_APP_PDF_LINK}
                target="new">{REACT_APP_NAME_PDF}</a>
              </React.Fragment>
              :
              ''
          }
          ...
          <a
            ...
            target="new">{REACT_APP_LINK4_NAME}
          </a>
        </div>
      </div>
      <div className="col-6 col-md">
